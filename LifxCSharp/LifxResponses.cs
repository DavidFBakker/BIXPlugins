...
namespace LifxCSharp
{
	...
	public class LightStateResponse : LifxResponse
	{
		...
		/// Hue
		/// </summary>
		public UInt16 Hue { get; internal set; }
		/// <summary>
		/// Saturation (0=desaturated, 65535 = fully saturated)
		/// </summary>
		public UInt16 Saturation { get; internal set; }
		/// <summary>
		/// Brightness (0=off, 65535=full brightness)
		/// </summary>
		public UInt16 Brightness { get; internal set; }
		/// <summary>
		/// Bulb color temperature
		/// </summary>
		public UInt16 Kelvin { get; internal set; }
		/// <summary>
		/// Power state
		/// </summary>
